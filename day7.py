...
def generateTree(name, level):
    ...
    children = {}
    total_size = 0
    # print((" " * (level - 1)) + name + ' lineNum: ' + str(lineNum))
    ...
    ## print(level)
    if lines and lines[0] == "$ cd ..":
        lines = lines[1:] # first element will be cd ..
        lineNum += 1
    # print((" " * (level - 1)) + "ending: " + name + ', ' + str(total_size) + str(total_size < 100000))
    
    ## print('line: ' + str(lineNum))
    return Tree(name, "dir", 0, children)
